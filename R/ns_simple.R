...
if (TRUE) {
lambdas <- seq(0.01,15,len=10) #c(0.01,5,10,15,25)
#lambdas <- 10
#lambdas <- c(500,1000)
for (lambda in lambdas) {
	fit <- ns_estimate_range(lambda=lambda, y=y, S=S, R=R, Rn=gridR$neighbors, B=B, Bn=gridB$neighbors)
